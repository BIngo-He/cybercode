"""
=====================================================================
sandbox_tools.py - 沙盒工具集
=====================================================================
主要功能：
1. 限制模型只能在 workspace/office 目录内操作
2. 提供文件列表、读取、写入功能
3. 提供 Shell 命令执行功能（带危险命令拦截）
4. 路径安全检查（防止越权访问）

安全机制：
- _get_safe_path(): 检查路径是否在 OFFICE_DIR 内
- 禁止危险命令：rm -rf, del /s, mkfs 等
=====================================================================
"""
...
# =====================================================================
# _get_safe_path() - 路径安全检查函数
# =====================================================================
# 作用：防止模型通过相对路径 "../" 逃逸出沙盒目录
# 参数：relative_path - 模型传入的相对路径
# 返回：绝对路径（如果安全）
# 异常：PermissionError（如果越权）
